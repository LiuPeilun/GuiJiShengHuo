...
class PageTwoViewController: UIViewController {
    ...
    func setUpScrollView(){
        ...
        scrollView.contentSize = CGSize(width: 414, height: 2313)
        self.view.addSubview(scrollView)
        
        let imageV : UIImageView = UIImageView(frame: CGRect(x: 0, y: 0, width: scrollView.frame.size.width, height: 2313))
        imageV.image = UIImage(named: "轮播2界面")
